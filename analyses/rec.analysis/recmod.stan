...
data { /////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int N_area ;   // Number of fishing areas
    int N_year ;  // Number of years 
    int N_area_year; // Number of area-year combinations
    int N_week ; // Number of weeks in dataset
    int N;    // Total number of observations
    
    //the below is frm ole's model- will change this to fishing regs
    ...
    // Covariates- ask ole what these are- not sure!
...
parameters { /////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Variance parameters for observation and random effects
      real<lower=0> sigma_area ;//fishing area sigma
...
transformed parameters { ////////////////////////////////////////////////////////////////////////////////
    ...
    // Variances
      ...
      sigma_all_samp = pow(sigma_stand_int^2 + sigma_pcr^2,-2) ;
