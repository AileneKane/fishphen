...
\item Altenratively/additionally: could make this more explicitly about changes in effort/presence-only database and citizen science. 
\end{enumerate}
...
\end{enumerate}
\item Trends in first and last observation dates of whales in upper Salish Sea (summer habitat) and south Puget Sound (winter habitat)
\end{enumerate}
