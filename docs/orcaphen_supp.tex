...
\label{tab:modsum}
\begingroup\footnotesize
\begin{tabular}{|p{0.02\textwidth}|p{0.15\textwidth}|p{0.06\textwidth}|p{0.04\textwidth}|p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}|p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}p{0.05\textwidth}|}
  \hline & & & & \multicolumn{5}{c |}{1978-2017 trend} &\multicolumn{5}{c |}{2002-2017 trend}\\
