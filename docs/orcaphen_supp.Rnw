...
print(modsum.table, include.rownames=FALSE, hline.after = c(0,6,12,18,24,30,36),caption.placement="top",size="\\footnotesize",sanitize.rownames.function=identity,add.to.row=addtorow)
@
